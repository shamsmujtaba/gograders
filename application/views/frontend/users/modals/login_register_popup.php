...
<div id="myModal" class="modal fade bs-example-modal-lg-login" tabindex="-1" role="dialog"
				...
				<div class="card-body" style="padding: 40px;">
					<form id="formLoginModal_pre">
						...
						<div class="row">
							...
							<div class="col-12 form-group">
								<span style="margin-bottom: 15px; margin-left: 7px;"> Keep me logged in</span>
							...
							<div style="margin-top: 40px;" class="col-12 form-group">
								...
								<input type="button" onclick="loginByModal('preLogin');"
					...
					<form id="formSignupModal_pre">
						...
						<div class="row">
							...
							<div style="margin-top: 40px;" class="col-12 form-group">
								...
								<input type="button" onclick="signUpByModal('preSignUp');"
									   class="button button-3d button-black m-0"
