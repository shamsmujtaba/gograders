						...
						<div class="tab-container">
							...
							<div class="tab-content clearfix ui-tabs-panel ui-corner-bottom ui-widget-content"
								...
								<div class="row">
										...
										<div class="testimonial">
											...
											<form action="<?= base_url('update-profile') ?>" method="post">
												...
												<div class="row" style="margin-bottom: 20px;">
													<div style="margin-bottom: 18px;" class="col-md-6">
														<input type="text" class="form-control" placeholder="Name"
															   value="<?= $user->username ?>" name="username" required>
													</div>
													<div class="col-md-6">
														<input type="text" class="form-control" placeholder="Email"
															   value="<?= $user->email ?>" id="mail" name="email"
															   required>
													</div>
												</div>
									...
									<div class="col-lg-6 bottommargin">
										<div style="height: 342px;" class="testimonial">
													...
													<div class="col-md-6 mb-3">
														...
														<div class="input-group toggle-password">
															...
															<button class="btn btn-outline-secondary icon-line-eye btn-password-toggle"
																	type="button"
																	style="border-color: #ced4da"></button>
														</div>
										...
										<div class="table-responsive m-t-40">
											<table id="myTable" class="table table-bordered table-striped">
												...
												Completed
														...
														<td>
															<a onclick="return getOrderDetails(<?= $order->order_id ?>);"
								...
								if ($have_addresses != 0) {
									...
									<div class="row col-md-12">
										...
										<div class="col-md-12">
											...
											<!--											<input checked -->
											<?php //if($have_addresses == 0){ echo "checked";}
											?><!-- style="display: inline-block;" class="form-check-input me-1" type="radio"-->
											...
											foreach ($user_addresses->result() as $user_address) { ?>
												...
												<div class="list-group">
													...
													<label class="list-group-item mb-0 nott fw-normal ls0 text-size-sm font-body">
														...
														<input <?php if ($user_address->is_selected == 1) {
															echo "checked";
														} ?> onclick="return makeVisible();"
															 style="display: inline-block;"
															 class="form-check-input me-1" type="radio"
															 name="address_<?= $count ?>" value="" aria-label="...">
														Block <?= $user_address->block . ', Street ' . $user_address->street . ', Area ' . $user_address->area . ', Building ' . $user_address->building . ', City ' . $user_address->state ?>

														| <a style="background-color: #444 !important;"
															 class="button button-3d button-mini button-rounded button-red address-del"
															 href="<?= base_url('delete-address/') ?><?= $user_address->address_id ?>">Delete</a>
													</label>
											...
											<a style="display: none;" href="#"
											   class="button bg-dark text-white button-dark brand-color btn-save-visible">Save</a>
							...
							<div class="tab-content clearfix ui-tabs-panel ui-corner-bottom ui-widget-content"
								...
								<div class="row col-md-12">
									...
									<div class="col-md-12">
										...
										<ol class="list-group list-group-numbered">
											<li class="list-group-item">
												...
												<a style="float: right;"
												   class="button bg-dark text-white button-dark brand-color btn-db-view"
												   href="javascript:void(0);" data-bs-target=".bs-example-modal-lg2"
									...
									<!--										<form name="addDependents" action="-->
									<? //= base_url('add-dependent') ?><!--"-->
									<!--											  method="post">-->
									<!--											<div class="row">-->
									<!---->
									<!---->
						...
						<div style="margin-bottom: 15px;" class="center">
							<a href="javascript:void(0);" class="standard-logo"
							   data-dark-logo="<?= asset_url() ?>front/images/logo.svg">
								<img class="order-img" style="max-width: 10%;"
									 src="<?= asset_url() ?>front/images/logo.svg"
									 alt="Tefsal Logo"></a>
						</div>
					</div>
...
<!--Modal-->
<div id="myModal" class="modal fade bs-example-modal-lg2" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="col-md-12">
					<div style="display: none" class="alert alert-danger alert-dismissible m-2 custom-alert"
						 role="alert"></div>
					...
					<form name="addnewDependents" id="frmAddDependents">
						<div class="row">
							...
							<div class="col-md-12 mb-3">
								...
								<input required="" name="dependent_name" placeholder="Name" type="text"
									   class="form-control">
							...
							<div class="col-md-12 mb-3">
								...
								<input required="" name="dependent_age" placeholder="Age" type="text"
									   class="form-control">
							...
							<div class="col-lg-12">
								<div class="profile-user-buttons" style="margin-top: 20px;">
									...
									<input type="button" onclick="addNewDependent();"
										   class="button bg-dark text-white button-dark brand-color"
										   name="login-form-submit" value="Save">
								</div>
							</div>
						</div>
					</form>
