						...
						<div class="card-body" style="padding: 40px;">
							<form id="login-form" name="login-form" class="mb-0" action="<?= base_url('check-login') ?>"
								...
								<div class="row">
									...
									<div class="col-12 form-group">
										<span style="margin-bottom: 15px;"> Keep me logged in</span>
										<input style="margin-left: 7px;" id="checkbox_2" type="checkbox"
											   name="remember_me"
											   value="1" <?php if (get_cookie("remeber") != '') { ?> checked="checked" <?php } ?> >
									</div>

									<div class="left">
										<h5 style="margin-bottom: 15px;"><a href="<?= base_url('sign-up') ?>">New
												Signup?</a></h5>
									</div>
