						...
						<div class="row form-section px-4 py-5 bg-white rounded shadow-lg">
							...
							<div class="col-6 form-group">
								...
								<input style="background-color: transparent;" readonly type="text"
									   ...
									   value="<?php if (isset($personal_details->dependent_name) and $personal_details->dependent_name != '') {
										   echo $personal_details->dependent_name;
									   } ?>" placeholder="Name">
							</div>
							<div class="col-6 form-group">
								<label>Age:</label>
								<input type="tel" name="age" id="landing-enquiry-phone"
									   class="form-control form-control-lg required"
									   value="<?php if(isset($personal_details->dependent_age) AND $personal_details->dependent_age !=''){ echo $personal_details->dependent_age; }?>" placeholder="25">
							</div>
...
//							$cat_id = '';
							...
							<input type="hidden" name="dependent_id" id="landing-enquiry-waist"
								   class="form-control form-control-lg required"
								   value="<?= $dependent_id ?>">
							...
							<div class="col-12">
								<button style="float: right" type="button"
										onclick="update_dependent_details(<?= $dependent_id ?>);"
