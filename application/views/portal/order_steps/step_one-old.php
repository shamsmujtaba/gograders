                         ...
                         <div class="">
                             <div class="">
                                 <div class="">
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Name:</label> <input onchange="saveData(0,'name');" type="text" class="form-control" id="name" name="name"> </div>
                                             <p style="color:red;" id="name-message"></p>
                                         </div>
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Email:</label> <input onchange="saveData(0,'email');" type="email" class="form-control" id="email" name="email"> </div>
                                 ...
                                 <div class="">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Topic:</label> <input onchange="saveData(0,'topic');" type="text" class="form-control" id="topic" placeholder="Topic" name="topic"> </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Number of sources/references:</label> <input onchange="saveData(0,'NumberSources');" name="NumberSources" type="text" class="form-control" id="NumberSources" placeholder="Number of sources/references" name="NumberSources"> </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-12">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Description:</label> <textarea onchange="saveData(0,'description');" name="description" id="description" class="form-control" rows="4" cols="50" name="comment"></textarea> </div>
