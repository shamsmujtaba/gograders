...
var btn1 = document.querySelector("[onclick=\"steps\('btn-step-one'\);\"]");
var btn2 = document.querySelector("[onclick=\"steps\('btn-step-two'\);\"]");
var btn3 = document.querySelector("#proceed-checkout");
btn1.classList.add('btn1');
btn2.classList.add('btn2');
btn3.classList.add('btn3');
var wc_phone = document.querySelector("#phone");
wc_phone.required = true;
var els = document.getElementById("formProceed").elements;
Array.prototype.forEach.call(els, function(elc) {
if (elc.tagName = 'input') {
elc.setAttribute("data-wc-ignore", "true");
}});
btn1.removeAttribute("data-wc-ignore");
wc_phone.removeAttribute("data-wc-ignore");
}
     ...
     <div class="container count">
         <div class="row container-div df">
             <div id="divId" class="col-md-7 form-outer-cont ord-cont-2 top-div " style="margin-bottom:30px">
                 ...
                 <form name="formProceed" id="formProceed" action="<?= base_url() ?>proceed_to_pay" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo $this->config->item('stripe_key') ?>" id="payment-form" enctype="multipart/form-data" onsubmit="return false"> <!-- Process 1 -->
                     <div class="order-form step-one-content">
                         <div class="ord-cont order-outer-cont">
                             <div class="row">
                                 <div class="col-md-8">
                                     <div class="form-group inp margin-btm"> <label class="control-label">Phone:</label> <input required onKeyPress="if(this.value.length==14) return false;" value="" placeholder="Enter phone number" name="phone" onchange="saveData(1,'phone');" id="phone" type="number" class="form-control"> <!--<input onKeyPress="if(this.value.length==10) return false;" value="" name="phone" onchange="saveData();" id="phone" type="number" class="form-control">--> <span id="valid-msg" class="hide">Valid</span> <span id="error-msg" class="hide">Invalid number</span> </div>
                             ...
                             <div class="row">
                                 <div class="col-md-12">
                                     <div class="form-group"> <label class="control-label">Type Of Document:</label> <select name="documentType" id="documentType" class="select-css-2" onchange="saveData(0,'documentType');">
                                             <option value="">Select Document Type</option> <?php foreach ($type_of_documents as $type_of_document) { ?> <option value="<?= $type_of_document->name ?>" <?php if (isset($order['documentType']) && ($type_of_document->name == $order['documentType'])) {
                                         ...
                                         <div class="">
                                             <div class="row">
                                                 <div class="col-md-3 custom-col">
                                                     <div class="radio-btn-cont"> <input <?php if (isset($order['acedamic_level']) && ($order['acedamic_level'] == "High School")) {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                                                 ...
                                                 <div class="col-md-3 custom-col">
                                                     <div id="u-g" class="radio-btn-cont"> <input <?php if (isset($order['acedamic_level']) && ($order['acedamic_level'] == "College UnderGraduate")) {
                                                                                                        echo 'checked';
                                                                                                    } else {
                                                                                                        echo '';
                                                 ...
                                                 <div class="col-md-3 custom-col">
                                                     <div class="radio-btn-cont"> <input <?php if (isset($order['acedamic_level']) && ($order['acedamic_level'] == "Masters")) {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                                                 ...
                                                 <div class="col-md-3 custom-col">
                                                     <div class="radio-btn-cont"> <input <?php if (isset($order['acedamic_level']) && ($order['acedamic_level'] == "PHD")) {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                             ...
                             <div class="row">
                                 <div class="col-md-8">
                                     <div class="inp-2"> <label class="control-label">Deadline Date:</label> <input min="<?= date('Y-m-d'); ?>" value="<?php if (isset($order['DeadlineDate'])) {
                                                                                                                                                            echo $order['DeadlineDate'];
                                                                                                                                                        } else {
                                                                                                                                                            echo '';
                                 ...
                                 <div class="col-md-4 deadline-pad">
                                     <div class="form-group"> <span class="afTimeOrder"> <select onchange="saveData(0,'hours');" name="hours" id="hours" class="select-css-2"> <?php
                                                                                                                                                                                ...
                                                                                                                                                                                ?> <option value="<?= $key->name ?>"><?= $key->name ?></option> <?php
                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                ?> </select> </span> </div>
                                 ...
                                 <div class="col-md-12">
                                     <div class="form-group"> <label class="control-label">No. of Pages:</label> <select name="pages" id="pages" onchange="saveData(0,'pages');" class="select-css-2">
                                             <option value="">Select No. of Pages</option> <?php
                                                                                            ...
                                                                                            ?>
                                                     <option value="<?= $key->id ?>" <?= ((isset($_POST['no_pages']) && $_POST['no_pages'] == $key->id) ? 'selected' : '') ?>><?= $key->name ?></option>
                                             <?php
                                                                                                }
                                                                                            }
                                                ?>
                             ...
                             <div class="row">
                                 <div class="col-md-6">
                                     <p class="mobile-detail" style="font-size:15px !important; font-weight:600; text-transform: none; "><span style="font-weight:bold; color: #0d2d82;">NOTE: </span>Please click on the NEXT button to get 10% extra discount.</p>
                                 </div>
                                 <div class="col-md-6">
                                     <button type="button"  onmouseover="pauseAnimation()" onmouseout="resumeAnimation()" onclick="steps('btn-step-one');" class="yellow-btn flip-button flip-button flip-animation" id="save-lead-button">                                       
                                       <span class="flip-button__front"><strong><i class="fa fa-spinner fa-spin text-bold" id="lead-loader" style="display: none;"></i></strong> <span id="extra-disscount">Add 10% Extra Discount</span>  <i class="fa fa-arrow-right" style="padding-left:10px;" aria-hidden="true"></i></span>
                                         <span class="flip-button__back">Next Step <i class="fa fa-arrow-right" style="padding-left:10px;" aria-hidden="true"></i>
                                         </span></button>
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="pkg-thumb discount-baner-inner"> <img src="<?= asset_url() ?>portal/images/merry-christmis-60.png" alt="Avatar" class="image">
                                     <div class="overlay">
                         ...
                         <div class="">
                             <div class="">
                                 <div class="">
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Name:</label> <input data-wc-ignore="true" onchange="saveData(0,'name');" type="text" class="form-control" id="name" name="name"> </div>
                                             <p style="color:red;" id="name-message"></p>
                                         </div>
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Email:</label> <input data-wc-ignore="true" onchange="saveData(0,'email');" type="email" class="form-control" id="email" name="email"> </div>
                                 ...
                                 <div class="">
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group margin-btm"> <label class="control-label">Subject:</label> <select data-wc-ignore="true" onchange="saveData(0,'projectsubject');" name="project_subject" class="select-css-2" id="projectsubject">
                                                     <option value="">Select Subject</option> <?php
                                                                                                if (!empty($subjects)) {
                                                                                                    foreach ($subjects as $subject) {
                                                                                                ?> <option value="<?= $subject->name ?>"><?= $subject->name ?></option> <?php
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                                        ?>
                                                 </select> </div>
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Topic:</label> <input data-wc-ignore="true" onchange="saveData(0,'topic');" type="text" class="form-control" id="topic" placeholder="Topic" name="topic"> </div>
                                             <p style="color:red;" id="topic-message"></p>
                                         </div>
                                     </div>
                                     <div class="row">
                                         <div class="col-md-12" id="othersubject1" style="display: none;">
                                             <div class="form-group margin-btm"> <label class="control-label">Other Subject: </label> <input data-wc-ignore="true" type="text" class="form-control" id="otherSubject" placeholder="Other Document Type" name="otherdocumentType" />
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Number of sources/references:</label> <input data-wc-ignore="true" onchange="saveData(0,'NumberSources');" name="NumberSources" type="text" class="form-control" id="NumberSources" placeholder="Number of sources/references" name="NumberSources"> </div>
                                             <p style="color:red;" id="number-sources-message"></p>
                                         </div>
                                         <div class="col-md-6">
                                             <div class="form-group margin-btm"> <label class="control-label">Citation Style:</label> <select data-wc-ignore="true" onchange="saveData(0,'otherCitationstyle');" name="citation_style" class="select-css-2" id="otherCitationstyle">
                                     ...
                                     <div class="row">
                                         <div class="col-md-12" id="otherCitation" style="display: none;">
                                             <div class="form-group margin-btm"> <label class="control-label">Other Citation:</label> <input data-wc-ignore="true" type="text" class="form-control" id="otherCitationValue" placeholder="Other Citation" name="otherCitation"> </div>
                                             <p style="color:red;" id="other-citation-message"></p>
                                         </div>
                                     </div>
                                     <div class="row">
                                         <div class="col-md-12">
                                             <div class="form-group inp margin-btm"> <label class="control-label">Description:</label> <textarea data-wc-ignore="true" onchange="saveData(0,'description');" name="description" id="description" class="form-control" rows="4" cols="50" name="comment"></textarea> </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-12">
                                             <div class="form-group margin-btm"> <label class="control-label">Attach file (optional):</label> <!-- <input type="file" name="files[]" class="form-group" id="attach" multiple> -->
                                                 <div class="fallback"> <input data-wc-ignore="true" type="hidden" name="myf" id="myf" value=""> <input id="new-multiple" name="img_post_blog" type="file" multiple /> </div>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                     ...
                                     <div class="col-md-12">
                                         <div class="main-tab">
                                             ...
                                             <div class="row"> <!-- ------------------Info Table start-------------- -->
                                                 ...
                                                 <input type="hidden" value="" id="country-cd" name="country_code" /> <input type="hidden" id="inputlead" value="0" name="lead_id"> <input type="hidden" id="eng_id" value="0" name="eng_id"> <input type="hidden" name="fullprice" class="auto-save" id="fullprice"> <input type="hidden" name="order_status" class="auto-save" id="order-status"> <input type="hidden" class="order_id" name="order_id" id="order_id" value="0"> <input type="hidden" name="actual" id="actual" value=""> <input type="hidden" name="actual-empty" id="actual-empty" value=""> <input type="hidden" name="discounted-price" id="discounted-price" value=""> <input type="hidden" name="checkStep" id="check-step" value=""> <input type="hidden" name="newUser" id="new-user" value="">
                                             ...
                                             <p class="sml-red" style="margin-bottom:20px">We are ready to start working on your paper as soon as the payment is made. We accept any major Debit/Credit cards. Click "Deposit Funds" to proceed to the secure payment page. If you want to change the initial requirements for this order, press the “Edit Order Details” and indicate all the necessary changes.</p>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                 ...
                 <div class="">
                     ...
                     <div id="white-container" class="pa-1">
                         ...
                         <div class="row prepay-cont" style="margin-bottom:20px; margin-top:10px;">
                             <div class="col-md-1 col-xs-1" id="prepaycheck"><input class="auto-save" type="checkbox" id="paymentStatus" onchange="saveData(0,'');" name="paymentStatus" value="1"></div>
                             <div class="col-md-3 col-xs-3 font-s-2" style="padding:0px;">Prepay 50%</div>
                             <div class="col-md-8 col-xs-8 font-s-2" style="padding:0px;">Discount <span class="discount-50-off">60% OFF:</span><span class="cut-through-2"><span class="c_sign">$</span><span class="total_pbd">68.20</span></span><span class="curved"><span class="c_sign">$</span><span class="you-pay">30.69</span></span></div>
                         </div>
                         ...
                         <div class="pay-now ">
                             <div class="col-md-12" style="padding:0px;">
                                 <div class="pay-now-cont"> Order Cost: <span class="c_sign"></span><span class="total">$0</span> </div>
                             </div>
                         </div>
                         <div class="clearfix"></div>
                     </div>
